			...
			<div class="panel-primary">
				...
				<div class="panel-body">
					...
					<sf:form class="form-horizontal" modelAttribute="product"
						action="${cr}/manage/products" method="post"
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<sf:textarea path="description" id="description"
									placeholder="product brand" class="form-control" rows="4"
									cols="50" />
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<sf:form id="categoryForm" modelAttribute="category"
						action="${cr}/manage/category" method="post"
						class="form-horizontal">
						<div class="form-group">
							<label for="category_name" class="control-label col-md-4">Add
								Category Name</label>
							<div class="col-md-8">
								<sf:input type="text" path="name" name="category_name"
									id="category_name" class="form-control" />
							</div>
						</div>
						<div class="form-group">
							<label for="category_descriptsion" class="control-label col-md-4">Add
								Description</label>
							<div class="col-md-8">
								<sf:textarea cols="" rows="4" path="descriptsion"
									class="form-control" />
							</div>
						</div>
						<div class="form-group">
