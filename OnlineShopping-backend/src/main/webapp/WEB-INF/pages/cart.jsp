<c:set var="availableCount" value="${userModel.cart.cartLine}" />
<div class="container">
					...
					<tr>
						...
						<td class="actions" data-th="">
							<c:if test="${cartLine.available == true}">
								<button type="button" id="refreshCart" name="refreshCart" class="btn btn-info btn-sm" value="${cartLine.id}"><span class="glyphicon glyphicon-refresh"></span></button>
							</c:if>												
